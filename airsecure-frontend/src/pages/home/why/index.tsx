      ...
      <div className="flex flex-col w-5/6 gap-y-8 mb-8 max-w-screen-2xl">
        ...
        <div className="flex flex-col lg:flex-row gap-x-8 gap-y-4">
          <div className="flex lg:w-1/2 w-full items-center gap-x-8 lg:justify-start justify-center">
            <ThermometerSunIcon className="h-12 w-12 text-green-secondary" />
            <p className="md:text-3xl font-semibold text-xl text-green-secondary">
              Improved System Efficiency
            </p>
          </div>
          <div className="lg:w-1/2 w-full">
            <p className="text-justify md:text-left text-green-secondary">
        ...
        <div className="flex flex-col lg:flex-row gap-x-8 gap-y-4">
          <div className="flex lg:w-1/2 w-full items-center gap-x-8 lg:justify-start justify-center">
            <SprayCan className="h-12 w-12 text-green-secondary" />
            <p className="md:text-3xl font-semibold text-xl text-green-secondary">Reduce Odors</p>
          </div>
          <div className="lg:w-1/2 w-full">
            <p className="text-justify md:text-left text-green-secondary">
        ...
        <div className="flex flex-col lg:flex-row gap-x-8 gap-y-4">
          <div className="flex lg:w-1/2 w-full items-center gap-x-8 lg:justify-start justify-center">
            <AirVent className="h-12 w-12 text-green-secondary" />
            <p className="md:text-3xl font-semibold text-xl text-green-secondary">
