...
export default function ScheduleAndEstimate() {
  ...
  return (
    <div className="w-full flex justify-center mb-40">
      <div className="w-5/6 max-w-screen-2xl flex flex-col gap-y-8">
        <Card className="md:w-[30rem]">
          <CardHeader className="flex flex-col items-center">
            <CardTitle className="md:text-4xl font-semibold text-3xl text-green-secondary">
              Don't need an estimate?
            </CardTitle>
